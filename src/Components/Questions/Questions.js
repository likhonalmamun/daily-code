    ...
    <div className="all-q">
      <div className="question">
        ...
        <p>
          ...
          finally it updates the particular component of the UI . Thats how it
          works .
        </p>
      </div>
      <div className="question">
        ...
        <p>
          ...
          key for creating a single page applications. when state is changed ,
          react knows that something need be to changed in the UI . Also props
          are immutable , they can not be changed after passing. But states are
      ...
      <div className="question">
        ...
        <p>
          ...
          useEffect hook like fetching data from API . But fetching is not the
          only purpose for using useEffect . Basically react makes the UI . But
          if we have to do other works like data fetching , setting Interval ,
          calling data base or we have to perform any asynchronous task we have
          to go with this useEffect hook . However it is also used to control a
          group of task that need to be executed only one time or on change of
